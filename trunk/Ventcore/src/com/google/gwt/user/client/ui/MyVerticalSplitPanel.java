...
public final class MyVerticalSplitPanel extends SplitPanel {
  ...
  private static class Impl {
    ...
    protected MyVerticalSplitPanel panel;

    public void init(MyVerticalSplitPanel panel) {
      this.panel = panel;
   ...
   */
  @Deprecated
  public MyVerticalSplitPanel(VerticalSplitPanelImages images) {
    this(images.verticalSplitPanelThumb());
  }

  public MyVerticalSplitPanel(Resources resources) {
    this(AbstractImagePrototype.create(resources.verticalSplitPanelThumb()));
  }

  private MyVerticalSplitPanel(AbstractImagePrototype thumbImage) {
